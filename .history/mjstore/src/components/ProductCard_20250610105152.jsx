...
<Col xs={12} sm={6} xs={12} sm={6} md={4}  id={_id}  >
<Card id={_id}  className=' p-1 shadow-sm  '  >
...
<div className=' d-md-flex justify-content-start '>
    <Button className='m-1 w-100' variant='dark' size='sm'>Add To Cart</Button>
    <Button className='m-1 w-100' variant='success' size='sm'>Buy Now</Button>
</div>
