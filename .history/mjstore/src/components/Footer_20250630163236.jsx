...
import { UserContext } from "../context/userContext"; // Context for login state
...
const Footer = () => {
  ...
  const fetchCartCount = async () => {
    ...
    if (!token) return; // Don't call the API if the user is not logged in
            ...
            <NavLink
              ...
              onClick={(e) => {
                if (!logged) {
                  ...
                  toast.warn("Please log in to access your account.");
                }
              }}
            >
