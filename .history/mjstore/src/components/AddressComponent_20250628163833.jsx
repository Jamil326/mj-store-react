...
const AddressForm = ({
  ...
  const toggleEdit = (field) => {
    if (field === "shippingName") setEditName((prev) => !prev);
    if (field === "shippingNumber") setEditMobile((prev) => !prev);
  };
  ...
  const handleSubmit = async (e) => {
    ...
    if (address.shippingNumber.length !== 10 || isNaN(address.shippingNumber)) {
