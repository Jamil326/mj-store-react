    ...
    <>
      <Container className="mt-5">
        <Row className="justify-content-center">
          <Col md={6}>
            <h2 className="text-center mb-4 text-dark fw-bold">Login to Your Account</h2>
            <Form
              className="p-4 shadow rounded-3 bg-white border"
              onSubmit={handleSubmit}
            >
              <Form.Group className="mb-3" controlId="formMobile">
                <Form.Label className="fw-bold text-secondary">Mobile</Form.Label>
                <Form.Control
                  type="tel"
                  name="mobile"
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title className="text-success fw-bold">Reset Password</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Form>
            <Form.Group className="mb-3" controlId="forgotMobile">
              <Form.Label className="fw-bold text-secondary">Mobile Number</Form.Label>
              <Form.Control
                type="tel"
                name="mobile"
                placeholder="Enter Mobile Number"
