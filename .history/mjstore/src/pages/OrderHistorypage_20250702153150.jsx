      ...
      >
        ...
        <Modal.Body>
          {selectedOrder && (
            <ListGroup>
              <ListGroup.Item>
                <strong>Date:</strong> {new Date(selectedOrder.createdAt).toLocaleString("en-IN", { timeZone: "Asia/Kolkata" })
}
              </ListGroup.Item>
              <ListGroup.Item>
              ...
              <ListGroup.Item>
                <strong>Status:</strong> {selectedOrder.orderStatus || "Processing"}
              </ListGroup.Item>
              <ListGroup.Item>
                <strong>Items:</strong>
                <ul className="mt-2">
                  {selectedOrder.items.map((item, idx) => (
                    <li key={idx} className="mb-3">
                      <Row>
                        ...
                        <Col xs={8} sm={9}>
                          <div className="fw-bold">{item.product?.name || "Unnamed Product"}</div>
                          <div className="text-muted small">{item.product?.title}</div>
                          <div>₹{item.product?.price || "N/A"}</div>
