...
const Home = () => {
  ...
  const GetId = (id)=> {
    ...
    const selected = product.find((item) => {
       return   item._id === id;
    })
    ...
    redir('productDetails',{state:{product:selected}});
    ...
    return (
       ...
       <ul className='list-unstyled d-flex  fw-bold    '>
         {categories.map((item,index)=> (
           <div className='d-flex flex-grow-1  flex-column p-2  m-3 bg-light shadow  justify-content-center rounded' key={index}  style={{cursor:'pointer'}}>
       ...
       <div className='d-flex justify-content-center align-items-center mt-3 mb-4'>
         <Button variant="dark" onClick = {HandlePrev} className='me-3 px-4'>Previous</Button>
         <Button variant='success' onClick = {HandleNext}  className='px-5'>Next</Button>
       </div>
