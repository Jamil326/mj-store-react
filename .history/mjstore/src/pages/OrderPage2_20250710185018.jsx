...
const OrderPage2 = () => {
  ...
  useEffect(() => {
    if (!userAddress || !street) fetchAddress();
  }, [userAddress, street, fetchAddress]);
  ...
  }, [items, navigate, token, userAddress]);
  ...
  return (
    <Container fluid className="py-4">
      <h1 className="text-center mb-4 text-dark py-2 rounded">
