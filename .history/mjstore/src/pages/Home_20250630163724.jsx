...
import { FaHeadphones, FaTools, FaShippingFast, FaExchangeAlt } from "react-icons/fa";
...
const Home = () => {
  ...
  const features = [
    ...
    { icon: <FaExchangeAlt />, text: "7 Days Replacement" },
  ...
  return (
    <div className="d-flex flex-column bg-light">
      {/* Banner Section */}
      <Container fluid className="py-3 bg-success text-white">
