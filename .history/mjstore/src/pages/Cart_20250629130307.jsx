  ...
  return (
    <div>
      ...
      <div className="text-center my-4">
        <h1 className="text-success fw-bold d-flex align-items-center justify-content-center gap-2">
      ...
      {cartData.length > 0 ? (
        <>
          ...
          <div className="d-flex flex-column gap-2 mt-3 mb-3 p-3">
            <Button onClick={handleCheckout} variant="success" className="w-100 d-flex align-items-center justify-content-center gap-2">
              <FaShoppingCart />
              Check Out
            </Button>
          </div>
