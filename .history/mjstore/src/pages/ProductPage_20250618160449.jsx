...
const ProductPage = () => {
  ...
  const fetchProducts = async (page, searchTerm = "") => {
    const limit = 16;
    const baseUrl = `https://mj-store.onrender.com/api/v1/product/get/product?page=${page}&limit=${limit}&search=${searchTerm}`;
    ...
    try {
      ...
      setFilteredProducts(data.data.getProduct); // Apply filters and sort on these.
