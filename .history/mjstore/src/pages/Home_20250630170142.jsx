...
const Home = () => {
  ...
  return (
    <div className="d-flex flex-column bg-light">
     ...
     <Container
      fluid
      className="py-3 rounded shadow-sm"
      style={{
        ...
        {categories.map((category, index) => (
          ...
          >
            <Card
              ...
              style={{
                cursor: "pointer",
                borderRadius: "16px", // Rounded corners for individual cards
              }}
            >
              <div
                className="text-center fs-2"
                style={{
                  color: "#198754", // Success theme
                  background: "rgba(25, 135, 84, 0.1)", // Light green background for icon area
