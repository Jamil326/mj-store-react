...
import { FaEnvelope, FaPhone, FaMapMarkerAlt, FaKey } from "react-icons/fa";
    ...
    <Container className="my-5">
              ...
              <ListGroup className="list-group-flush">
                ...
                {user.address && (
                  ...
                  >
                    ...
                    <span>{`Street: ${user.address.street || "N/A"}`}</span>
                    <span>{`Landmark: ${user.address.landmark || "N/A"}`}</span>
                    <span>{`City: ${user.address.city || "N/A"}`}</span>
                    <span>{`State: ${user.address.state || "N/A"}`}</span>
                    <span>{`Pin: ${user.address.pin || "N/A"}`}</span>
                    <Button
                      variant="link"
      ...
      <Modal show={showEditModal} onHide={() => setShowEditModal(false)} centered>
        <Modal.Header closeButton>
          <Modal.Title>Edit {editData.field}</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Form>
