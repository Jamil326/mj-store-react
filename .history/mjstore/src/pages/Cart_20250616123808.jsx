      ...
      <div>
          {
              ...
              )):( <div className='justify-content-center align'>
                     
                     <div className='d-flex flex-column jsutify-content-center' style={{fontSize:'50px'}}>
                              < HiOutlineShoppingCart className='bg-light ' />
