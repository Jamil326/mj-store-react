...
const Orders = () => {
  ...
  return (
    <Container fluid className="py-4">
      ...
      {orders.length > 0 ? (
        orders.map((order) => {
          const { progress, index } = getDeliveryProgress(order.orderStatus);
                  ...
                  <div>
                    ...
                    <div className="mt-3">
                      ...
                      <div className="d-flex justify-content-between mt-2">
                        <small className={index >= 0 ? "text-success" : "text-muted"}>
                          <FaHourglassHalf /> Pending
                        </small>
                        <small className={index >= 1 ? "text-success" : "text-muted"}>
                          <FaShippingFast /> Shipped
                        </small>
                        <small className={index >= 2 ? "text-success" : "text-muted"}>
                          <FaTruckLoading /> Out for Delivery
                        </small>
                        <small className={index >= 3 ? "text-success" : "text-muted"}>
