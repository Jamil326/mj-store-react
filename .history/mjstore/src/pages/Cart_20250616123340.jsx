      ...
      <div>
          {
              items.length>0?items.map(( item, index)=> (
                  <div key={index}>
                     ...
                     <div className=' ms-5 p-1 bg-dark mt-5 col-3' style={{fontSize:'50px'}}>
                                           < HiOutlineShoppingCart className='bg-light p-2 w-100 h-100' />

                     </div>

                     
                         <span className='text-dark text-center'>Cart is Empty</span>
