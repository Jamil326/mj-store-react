        ...
        <Col>
          <ListGroup>
            ...
            <ListGroup.Item className=''>
              ...
              <Button onClick={handleSub} variant="border border-success ms-3 py-1">
                <span>-</span>
              </Button>
              <span className="mx-2 fs-3  text-center px-3 pb-2">{noItem}</span>
              <Button onClick={handleAdd} variant="border border-success py-1">
                <span>+</span>
              </Button>
            </ListGroup.Item>
            <ListGroup.Item>
