...
const Orders = () => {
  ...
  return (
    <Container fluid className="py-4">
      <h1 className="text-center text-dark mb-4" style={{ fontWeight: "600", color: "#FF5675" }}>
        My Orders
      </h1>
      ...
      <Card className="mb-4 shadow-sm border-0 text-center">
        <Card.Body>
          <h6 className="mb-0 d-flex justify-content-center align-items-center" style={{ fontWeight: "600" }}>
            ...
            Total Orders: <span className='text-success' style={{ marginLeft: "8px", color: "#007bff" }}>{orders.length}</span>
          </h6>
        </Card.Body>
      </Card>
