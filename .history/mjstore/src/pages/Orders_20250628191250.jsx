...
import { FaTruck, FaMapMarkerAlt, FaBox, FaRupeeSign, FaClipboardList, FaMoneyBillAlt } from "react-icons/fa";
...
const Orders = () => {
  ...
  return (
    <Container fluid className="py-4">
      ...
      {orders.length > 0 ? (
        orders.map((order) => (
          <Card key={order._id} className="mb-4 shadow-sm border-0" style={{ borderRadius: "12px" }}>
            <Row noGutters>
                ...
                <div>
                  ...
                  <p className="mb-1 d-flex align-items-center">
                    ...
                    <span style={{ fontWeight: "500", color: "#333" }}>
                      Expected Delivery:{" "}
                      {order.deliveryDate || "Not Available"}
                    </span>
                  </p>
                </div>
        ...
        <div className="d-flex flex-column justify-content-center align-items-center vh-100">
          <img src="/no-orders.svg" alt="No Orders" style={{ width: "150px", marginBottom: "20px" }} />
